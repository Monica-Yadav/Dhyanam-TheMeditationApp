    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Ambience.this, DashBoardActivity.class));
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.airyandspacemeditation);
        mediaPlayer2 = MediaPlayer.create(this, R.raw.aurameditation);
        mediaPlayer3 = MediaPlayer.create(this, R.raw.raindropsambientsoundscape);
