...
public class Cate_NatureVibes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cate__naturevibes);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cate_NatureVibes.this, DashBoardActivity.class);
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.birdsinthejungle);
        mediaPlayer2 = MediaPlayer.create(this, R.raw.theforestwalk);
        mediaPlayer3 = MediaPlayer.create(this, R.raw.morningsoundinagarden);
        mediaPlayer4 = MediaPlayer.create(this, R.raw.calmthunderstorminthejungle);
        mediaPlayer5 = MediaPlayer.create(this, R.raw.churchbell);
        mediaPlayer6 = MediaPlayer.create(this, R.raw.lightrainloop);
