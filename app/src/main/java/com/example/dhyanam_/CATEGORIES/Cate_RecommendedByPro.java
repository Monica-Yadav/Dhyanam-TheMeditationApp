...
public class Cate_RecommendedByPro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cate_recom_by_pro);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Cate_RecommendedByPro.this, DashBoardActivity.class));
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.binauralsleepmeditation);
        mediaPlayer2 = MediaPlayer.create(this, R.raw.rejuvenatemeditation);
        mediaPlayer3 = MediaPlayer.create(this, R.raw.nirvanameditation);
